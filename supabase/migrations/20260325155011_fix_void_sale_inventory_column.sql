/*
  # Fix void_sale function to use correct inventory column name

  1. Changes
    - Update `void_sale()` function to use `quantity` instead of `current_stock`
    - The inventory table uses `quantity` as the column name, not `current_stock`
