/*
  # Add Inventory Valuation View

  ## Overview
  This migration creates a database view for comprehensive inventory valuation
  and profit analytics with real-time calculations.
  ...
  ## Business Logic
  - Calculates store-wide asset value
  - Identifies products with missing cost data
  - Flags negative stock items for correction
  - Provides category-level valuation grouping
  - Supports margin analysis and low-margin identification

  ## Security
  - View inherits RLS policies from underlying tables
  - Authenticated users can view valuation data
*/
